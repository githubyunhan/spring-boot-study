...
import cn.itcast.springbootstudy.config.exception.CustomException;
import cn.itcast.springbootstudy.config.exception.CustomExceptionType;
...
public class ExceptionService {
    ...
    public void systemBizError() throws CustomException{
        try {
            ...
            throw new CustomException(CustomExceptionType.SYSTEM_ERROR,"在xxxx业务，myBiz()方法内，出现ClassNotFoundException");
        }
    }
