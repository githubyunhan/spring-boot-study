package cn.itcast.springbootstudy.config.accesslog;

import cn.itcast.springbootstudy.utils.AdrressIpUtils;
...
/*Interceptor属于AOP切面编程，针对controller进行操作*/
@Slf4j
public class AccessLogInterceptor implements HandlerInterceptor {/*②定义日志拦截器*/
    //请求开始时间标识
...
/*请求前调用；返回false则请求中断；可以添加记录*/
    ...
    @Override
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {/*afterCompletion:请求调用完成后回调方法，即在视图渲染完成后回调*/
